...
import type { ScrapedProduct } from '@/lib/features/scraper/scraper';

type ComparisonProduct = ScrapedProduct & { dbId: string };

export default function CompareClient() {
    const [comparisonData, setComparisonData] = useState<ComparisonProduct[] | null>(null);
                    ...
                    {isLoading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 stagger-children">
                            {[
                                ...
                                <div key={feature.title} className="p-10 glass rounded-[2.5rem] border border-[var(--border)] card-glow h-full flex flex-col items-center text-center">
