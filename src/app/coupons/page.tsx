    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-gray-950 pb-20">
                ...
                {/* Filter & Search Bar */}
                <section className="sticky top-[64px] z-40 bg-gray-950/80 backdrop-blur-md border-b border-gray-800">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    {coupons.length === 0 && (
                        <div className="text-center py-20">
                            <Ticket size={48} className="text-gray-800 mx-auto mb-4" />
                            <h3 className="text-xl font-bold text-gray-400">No coupons found</h3>
                            <p className="text-gray-600 mt-2">Check back later for fresh deals!</p>
                        </div>
                    )}
                </section>
            </main>
