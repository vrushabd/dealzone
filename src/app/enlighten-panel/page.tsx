...
export default async function AdminDashboard() {
    ...
    const stats = [
        { label: "Total Products", value: productCount, icon: ShoppingBag, href: "/enlighten-panel/products", color: "orange" },
        { label: "Total Orders", value: totalClicks, icon: TrendingUp, href: "/enlighten-panel/orders", color: "blue" },
        { label: "Featured Deals", value: featuredCount, icon: Star, href: "/enlighten-panel/products", color: "yellow" },
    ...
    return (
        <div className="animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {[
                    { href: "/enlighten-panel/posts/new", label: "New Post", desc: "Write a blog post" },
                    { href: "/enlighten-panel/categories", label: "Add Category", desc: "Organise your products" },
                ].map(({ href, label, desc }) => (
                    <Link
                        key={href}
                        href={href}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-md overflow-hidden">
                    <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border)]">
                        ...
                        <Link href="/enlighten-panel/products" className="text-xs text-[hsl(214_89%_55%)] hover:text-[hsl(214_89%_62%)] flex items-center gap-1 transition-colors">
                    ...
                    {recentProducts.length === 0 ? (
                        <div className="py-12 text-center text-gray-500 text-sm">
                            No products yet. <Link href="/enlighten-panel/products" className="text-[hsl(214_89%_55%)] hover:underline">Add your first deal →</Link>
                        </div>
                    ) : (
