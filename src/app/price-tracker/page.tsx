            ...
            <main className="flex-1 py-12 px-4 sm:px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-16 animate-fade-in">
                        <div className="inline-flex items-center gap-2 bg-orange-500/10 text-orange-500 px-4 py-2 rounded-full font-bold text-xs uppercase tracking-widest border border-orange-500/20 mb-6 backdrop-blur-sm">
                            <TrendingDown size={14} />
                            Save up to 60%
                        </div>
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[var(--text-primary)] mb-6 tracking-tight leading-[1.1]">
                            Never Pay <span className="text-orange-500">Full Price</span> <br className="hidden sm:block" /> Again
                        </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
                        <div className="bg-[var(--bg-card)] border border-[var(--border)] p-8 rounded-3xl hover:border-orange-500/30 transition-all hover:shadow-xl group">
