...
const iconMap: Record<string, React.ElementType> = {
    electronics:    UilMobileAndroid,
    fashion:        UilBag,
    "home-kitchen": UilHome,
    beauty:         UilBright,
    gaming:         UilGameStructure,
    books:          UilBook,
    tv:             UilDesktop,
    audio:          UilHeadphones,
    cameras:        UilCamera,
    ...
    watches:        UilWatch,
    bags:           UilShoppingBag,
    mobiles:        UilMobileAndroid,
    "smart-phone":  UilMobileAndroid,
};
...
const colorMap: Record<string, string> = {
    ...
    mobiles:        "text-blue-400   bg-blue-500/10   border-blue-500/20",
    "smart-phone":  "text-sky-400    bg-sky-500/10    border-sky-500/20",
};
